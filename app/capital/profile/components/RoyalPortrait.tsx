...
export default function RoyalPortrait({
  ...
  const handlePhotoSelect = (
     ...
     *
     * The actual File is also sent back
     * to the Profile page so it can later
  ...
  return (
    <div className="mt-8">
      ...
      <button
        ...
        className="mx-auto mt-5 block rounded-xl border border-yellow-500/30 bg-transparent px-5 py-3 text-sm font-bold text-yellow-400 transition hover:border-yellow-400 hover:bg-yellow-400/10 active:scale-[0.98]"
      >
        {selectedPhoto
